...
void I2C_Init(I2C_Handle_t *pI2CHandle)
{
	...
	//configure the FERQ field of CR2
	tempreg = 0;
	...
	}else
	{
		//mode if fast mode
		tempreg|= (1 << 15);
		tempreg|= (pI2CHandle->I2C_Config.I2C_FMDutyClycle << 14);
...
//Master Send Data and recevive data
...
void I2C_MasterSendData(I2C_Handle_t *pI2CHandle, uint8_t *pTxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr)
{
	...
	//5. Clear the ADDR flag according to its S/W sequence
	// Note: Until ADDR is cleared SCL will be strected, pulled to low
...
void I2C_MasterReceiveData(I2C_Handle_t *pI2CHandle, uint8_t *pRxBuffer, uint32_t Len, uint8_t SlaveAddr, uint8_t Sr)
{
	...
	{
		//Disable Acking
		I2C_ManageAcking(pI2CHandle->pI2Cx,I2C_ACK_DIABLE);
