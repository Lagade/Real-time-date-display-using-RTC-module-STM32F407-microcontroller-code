...
/*
 * Configuration structure of I2Cx pripherals
 */
typedef struct
{
...
#define I2C_SCL_SPEED_FM2K    200000       //200LKHZ
...
void I2C_SlaveEnableDisableEventCallback(I2C_Handle_t *pI2CHandle, uint8_t EnorDi);
