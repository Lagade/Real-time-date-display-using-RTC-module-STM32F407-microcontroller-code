...
I2C_Handle_t g_ds1307I2CHandle;  // I2C handler global I2C variable
...
uint8_t ds1307_init(void)
{
	...
	//2. Initialize the I2C peripherals
	ds1307_i2c_config();

	//3. Enable the I2C peripherals
	...
	return ((clock_state << 7) & 0x1); // CH is at bit 7 and it should return its state
